...
function action(mode, type, selection) {
	...
	if (status == 0) {
		...
		if (selected == 0) {
			if (cm.haveItem(4011000) && cm.haveItem(4011001) && cm.haveItem(4011002) && cm.haveItem(4011003) && cm.haveItem(4011004) && cm.haveItem(4011005) && cm.haveItem(4011006) && cm.getPlayer().getMeso() > 10000) {
				cm.gainMeso(-10000);
			...
			if (cm.haveItem(4021000) && cm.haveItem(4021001) && cm.haveItem(4021002) && cm.haveItem(4021003) && cm.haveItem(4021004) && cm.haveItem(4021005) && cm.haveItem(4021006) && cm.haveItem(4021007) && cm.haveItem(4021008) && cm.getPlayer().getMeso() > 15000) {
				cm.gainMeso(-15000);
			...
			if (cm.haveItem(4001006) && cm.haveItem(4011007) && cm.haveItem(4021008) && cm.getPlayer().getMeso() > 30000) {
				cm.gainMeso(-30000);
