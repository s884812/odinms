...
function action(mode, type, selection) {
	...
	if(status == 0) {
		...
		cm.sendNext("Hello there! This Bullet Taxi will take you to any danger zone from #m"+cm.getPlayer().getMapId()+"# to #b#m"+toMap[location]+"##k on this Ossyria Continent! The transportation fee of #b"+cost+" meso#k may seem expensive, but not that much when you want to easily transport through danger zones!");
	} else if(status == 1) {
