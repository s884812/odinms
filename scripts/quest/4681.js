...
function start(mode, type, selection) {
	...
	case 100:
		...
		if (qm.haveItem(4000343, 1) && qm.haveItem(4000340, 300) && qm.haveItem(4000342, 1)) {
		    ...
		    qm.sendNext("This isn't enough for me to gauge the extent of your power. I want you to defeat more monsters inside the castle and bring sufficient amount of evidence, okay?");
		    qm.dispose();
		}
	    } else {
