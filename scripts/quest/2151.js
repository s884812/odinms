...
function start(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			...
			qm.sendNextPrev("The ghost tree does exist and has terrorized #rPerion#k for as long as I can remember, but I don't know how to deal with something that is a soul...");
		} else if (status == 2) {
