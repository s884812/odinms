...
public class MapleMapFactory {
    ...
    private static final org.slf4j.Logger Logger = org.slf4j.LoggerFactory.getLogger(MapleMapFactory.class);
    ...
    public MapleMap getMap(int mapid, boolean respawns, boolean npcs, boolean reactors) {
        ...
        if (map == null) {
            synchronized (this) {
                ...
                allFootholds.stream().forEach((fh) -> {
                    fTree.insert(fh);
                });
...
//                }
    ...
    private void loadSpawnsFromdb(MapleMap map) {
        try {
