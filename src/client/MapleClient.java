...
public class MapleClient {
    ...
    private static final org.slf4j.Logger Logger = org.slf4j.LoggerFactory.getLogger(MapleClient.class);
    ...
    public List<MapleCharacter> loadCharacters(int serverId) { // TODO make this less costly zZz
        ...
        for (CharNameAndId cni : loadCharactersInternal(serverId)) {
            try {
                ...
                Logger.error("Loading characters failed", e);
            }
        }
        return chars;
    }
                ...
                try {
                    ...
                    if (chr.getParty() != null) {
                        try {
                            ...
                            Logger.warn("Failed removing party character. Player already removed.", e);
                        }
                    }
                    ...
                    if (getChannelServer() != null) {
                        ...
                        Logger.error(getLogMessage(this, "No channelserver associated to char {}", chr.getName()));
                    }
                }
            }
            if (close) {
