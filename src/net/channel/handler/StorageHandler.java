    ...
    public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        if (mode == 4) { // Take out.
            ...
            if (item != null) {
                ...
                AutobanManager.getInstance().autoban(c, "Tentando tirar item de armazenamento que nao existe.");
                return;
            }
            ...
            if (quantity < 1) {
                AutobanManager.getInstance().autoban(c, "Tentar armazenar " + quantity + " de " + itemId);
                return;
            }
            if (storage.isFull()) {
            ...
            if (c.getPlayer().getMeso() < 100) {
                c.getSession().write(MaplePacketCreator.serverNotice(1, "Voce nao tem mesos suficiente para armazenar o item"));
            } else {
