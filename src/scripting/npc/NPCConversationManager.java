...
public class NPCConversationManager extends AbstractPlayerInteraction {
    ...
    public void processGachapon(int[] id, boolean remote) {
        ...
        sendNext("Voce obteve um(a) #b#t" + itemid + "##k.");
        dispose();
    }
    ...
    public void changeOccupationById(int occ) {
        getPlayer().changeOccupation(LeaderOcupacoes.getById(occ));
        LeaderOcupacoes.getOcupacaoItem(c);
        getPlayer().sendServerNotice("<Leader Ocupacoes> Parabens " + getPlayer().getName() + ", voce agora e um " + getPlayer().getOccupation() + ".");
    }
    ...
    public void gainNeckson(int gain) {
        ...
        if (gain > 0) {
            playerMessage(5, "Voce ganhou LeaderNX (+" + gain + ")");
        } else {
            playerMessage(5, "Voce ganhou LeaderNX (-" + gain + ")");
        }
    }
    ...
    public void gainLeaderPoints(int gain) {
        ...
        getPlayer().getClient().getSession().write(MaplePacketCreator.serverNotice(6, "[LeaderPoints] Voce " + (gain > 0 ? "ganhou" : "perdeu") + " (" + gain + ") LeaderPoints."));
    }
    ...
    public void gainvotePoints(int gain) {
        ...
        getPlayer().getClient().getSession().write(MaplePacketCreator.serverNotice(6, "[Vote Points] Voce " + (gain > 0 ? "ganhou" : "perdeu") + " (" + gain + ") Vote Points."));
    }
    ...
    public void gainPQPoints(int gain) {
        ...
        getPlayer().dropMessage("[LeaderMS Quest] Quest completa com sucesso, voce tem agora (" + getPlayer().getpqPoints() + ") Q.Points!");
    }
